...
namespace PQMS
{
    public partial class frmSTAFF_TRAIN_OBJECT : MetroFramework.Forms.MetroForm
    {
        public frmSTAFF_TRAIN_OBJECT()
        {
            InitializeComponent();
        }
        ...
        {
            Form2STAFF_TRAIN_OBJECTIVE.sSTAFF_TRAIN_OBJECTIVE = txtSTAFF_TRAIN_OBJECTIVE.Text;
            this.Close();
        }

        private void frmSTAFF_TRAIN_OBJECT_Load(object sender, EventArgs e)
        {
            txtSTAFF_TRAIN_OBJECTIVE.Text = Form2STAFF_TRAIN_OBJECTIVE.sSTAFF_TRAIN_OBJECTIVE;
