...
namespace PQMS
{
    public static class AppRes
    {
        ...
        public static void Create()
        {
            ...
            // Data Source=KRSEC001;Initial catalog=NEW_PQMS;User ID=pqms;Password=PQMS;Connection Timeout=600;
            // crypto 암호화
            ...
            DB = new AppDatabase("Data Source=KRSEC001;Initial catalog=NEW_PQMS;User ID=pqms;Password=PQMS;Connection Timeout=600;");
            DB.Open();
        }
